...
\par{\centering{\sffamily\LARGE\textsc{Your Name}}\\ % Your name
...
\raisebox{-3pt}{\small\faPhone} & (010)1234~5678 \\ % Phone number
\raisebox{-3pt}{\Large\faMobilePhone} & (+86)~123~45678910 \\ % Phone number
\raisebox{-1pt}{\small\faEnvelope} & \href{mailto:username@cnu.edu.cn}{username@cnu.edu.cn} \\ % Email address
\faLink & \href{http://www.example.com}{http://www.example.com} \\ % Website
\end{tabular}
}
}\\[5pt]
