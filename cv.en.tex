...
\par{\centering{\sffamily\Huge\textsc{Wan Hu}}\\ % Your name
...
\raisebox{-3pt}{\Mobilefone} & (+86) 152 10594789 \\ % Phone number
\raisebox{-1pt}{\Letter} & \href{mailto:wanhu@cnu.edu.cn}{wanhu@cnu.edu.cn} \\ % Email address
\Keyboard & \href{http://mengyingchina.github.com}{http://mengyingchina.github.com} \\ % Website
\end{tabular}
}
}\\[5pt]
